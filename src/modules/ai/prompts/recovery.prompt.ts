...
export function buildRecoveryPrompt(request: RecoveryRequest): string {
  ...
  return [
    ...
    '',
    'DIRETRIZES:',
    '1. CORRESPONDÊNCIA SEMÂNTICA: Se o usuário digitou algo parecido com uma das opções (ex: "Gastos" para "Registrar", ou "Resumo" para "Relatórios"), retorne action: "CONTINUE_TYPEBOT" com a opção exata em matchedOption.',
    '2. MENSAGEM CURTA: Se precisar orientar o usuário, use no máximo 2 frases.',
    '3. FORA DE CONTEXTO: Se não tiver relação com nenhuma opção, retorne action: "REDISPLAY_MENU" instruindo o usuário a escolher uma das opções ou digitar MENU.',
    ...
    '',
    'CENÁRIO 1: A mensagem bate com uma opção (ex: usuário quer registrar gasto e a opção é "Registrar"):',
    '{',
